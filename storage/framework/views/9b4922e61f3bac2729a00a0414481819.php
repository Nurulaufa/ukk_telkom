...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Your App Name'); ?></title>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="<?php echo e(route('foto.index')); ?>">Foto</a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                ...
                <?php if(Auth::check()): ?>
                    ...
                    <form action="<?php echo e(route('auth.logout')); ?>" method="POST" style="display:none;" id="logout-form">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\STELLA 02\ukk_telkom\resources\views/layouts/app.blade.php ENDPATH**/ ?>